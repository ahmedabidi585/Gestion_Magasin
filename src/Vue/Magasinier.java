...
public class Magasinier extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
			try {
				Magasinier frame = new Magasinier();
	...
	public Magasinier() {
		...
		JLabel lblNewLabel = new JLabel("Magasinier :");
		...
		btnNewButton_3.addActionListener(e -> UiUtils.navigate(new Login(), Magasinier.this));
		btnNewButton_3.setFont(new Font("Arial", Font.BOLD, 10));
		btnNewButton_3.setBounds(10, 28, 97, 21);
		panel_1.add(btnNewButton_3);

		JButton btnNewButton = new JButton("Entrée des articles en stock ");
		btnNewButton.addActionListener(e -> UiUtils.navigate(new Entrestock(), Magasinier.this));
		btnNewButton.setFont(new Font("Yu Gothic Light", Font.BOLD, 15));
		btnNewButton.setBounds(354, 149, 232, 62);
		contentPane.add(btnNewButton);

		JButton btnNewButton_1 = new JButton("Sortie des articles en stock ");
		btnNewButton_1.addActionListener(e -> UiUtils.navigate(new Sortiestock(), Magasinier.this));
		btnNewButton_1.setFont(new Font("Yu Gothic Light", Font.BOLD, 15));
		btnNewButton_1.setBounds(354, 244, 232, 62);
		contentPane.add(btnNewButton_1);

		JButton btnNewButton_2 = new JButton("Article en stock ");
		btnNewButton_2.addActionListener(e -> UiUtils.navigate(new Affichage(), Magasinier.this));
		btnNewButton_2.setFont(new Font("Yu Gothic Light", Font.BOLD, 15));
		btnNewButton_2.setBounds(354, 342, 232, 62);
